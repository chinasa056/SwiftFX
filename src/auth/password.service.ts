...
//     const logoUrl = `${baseUrl}/img/logo1.png`;
...
//       const resetLink = `https://adeonai-server-zja8.onrender.com/resetPassword?token=${resetToken}`;
//       await this.mailerService.sendMail({
//         to: user.email,
//         subject: 'Password Reset Request',
//         template: './reset-password',
//         context: { logoUrl, resetLink },
//       });
...
//       throw new HttpException('Account has no password set. Cannot change password.', HttpStatus.BAD_REQUEST);
//     }
